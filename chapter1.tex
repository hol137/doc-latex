...
In particular, the relation $R/ \lambdabar_{e} ~ ( CMB / \lambdabar_{e} )^{4}$ ties two cosmic lengths, the Hubble radius and the CMB wavelength by a relation incompatible with the standard evolutionary cosmology. Of this order of
...
(  CNB 2 /  CMB \lambdabar_{e} ) 4 to $1.7{percent}$$. Second, with the Hydrogen radius $$r H(0) = a\lambdabar_{e} , we infer R/r H(0) ~
...
$R/√(\lambdabar_{p} \lambdabar_{H}) ≈ (WZ)^4$
...
292.806161(6) GeV \approx 573007.33(25) m_e c 2 , itself tied to the weak force constant $$G_{F} ≡ (\hbar c) 3 /E_{F} 2 \approx
