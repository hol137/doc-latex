...
$(R_{GC}/\lambdabar_e)^3 \approx 150^{137}$, so the quark hypothesis u = 5, d = 6 is comforted by the Grandcosmos. This would imply that the quark d is composite.
 In Atiyah's last work the Bernoulli function $x/(1-e^{-x})$ is used. Now, this is the kernel of the thermal Planck law. Indeed, considering the Wien reduced constant $w = hc/kT\lambda_{Wien} = 5 (1-e^{-w}) ≈ 4.965114245, one notes that $a ≈ e^w -2\pi$, suggesting $a$ to be a trigonometric line. Indeed $cosa ≈ 1/e$, and, to 65 ppb:
\begin{equation}
a ≈ 44\pi - Arccos(1/e)
\end{equation}
