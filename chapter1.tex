...
corresponding to n ≈ 2e e , to 0.01 %, The Topological Axis illustrates the function f{n + 4} = f 2 {n}
...
(  CNB 2 /  CMB ƛ e ) 4 to 1.7 %. Second, with the Hydrogen radius r H(0) = aƛ e , we infer R/r H(0) ~
...
the Lenz-Wyler approximation for the Proton/Electron mass ratio $p = 6π 5$ , (see Section III). Recall
