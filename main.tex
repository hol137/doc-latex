...
magnitude, we infer rather precise relations. With the Hydrogen radius r_{H(0), we infer $R/r_{H(0)} \sim (4\pi \lambda_{CMB} /r_{H(0)} )^{4}$

First, considering the cosmological neutrino
