...
\begin{table}
 \caption{Data Sample table}
  \centering
  \begin{tabular}{llllll}
    \toprule
    \multicolumn{6}{c}{Part}                   \\
    \cmidrule(r){1-6}
    Element Name     & k     & d=$2+4k$) & $lnln(f(d))$ & Measured & Theoritical Measure $f(d)$ \\
    \midrule
    string & 0  & 2 & 0.347 & $f(n) = 4.113 = 10^(0.6142)$ & NYD \\
    gluon  & 1 & 6 & 0.347 & $f(n) = 16.92 = 10^(1.228)$ & NYD \\   
    mean pion & 2  & 10 & 1.722 & $f(n) = 286.25 = 10^(2.457)$ & NYD \\ 
    ...
    Thermal Photon & 4  & 18 & 3.120 & $f(n) = 6.714  10^9 = 10^(9.827)$ & NYD \\
    Boson GUT pion & 5  & 22 & 3.794 & $f(n)  = 10^(19.65)$ & NYD  \\
    Hubble perimeter & 6  & 26 & 4.506 & $f(n) = 10^(39.31)$ & NYD  \\
    Graviton & 6  & 26 & 4.506 & $3.72 10(-67) kg$ & $10^(39.31)$  \\
    SuperCycle & 7  & 30 & 5.199 & $5.483 10^57 s$ & $10^(78.62)$ \\
    Topon & $2e^e$  & 30.31 & 5.253 & 5.252 & $10^(82.93)$ \\
