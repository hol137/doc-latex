...
We look here for relations involving $e$, $\pi$ and $\Gamma \approx, noting firstly that (6.5 ppm):
\begin{equation}
p \approx \Gamma (\pi e)^2
\end{equation}
confirming the central role of Atiyah's constant $\Gamma$. 
...
\begin{equation} 
(p/n) (R/\lambdabar_{e})^{2} \approx (f(26)/6)^{2} \approx (2\pi^{2} a^{3})^{10} \approx \pi_R^{155}
\end{equation}
