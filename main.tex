...
The last equation means the implication of $B = e^{(e^{\pi}} $ in the ultimate theory. Indeed, it appears in the following relation, with the Fermi-Electron mass ratio $F$ value of Section 4, to 0.3 ppm and 0.03 \% :
