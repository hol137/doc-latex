...
Since $R/\lambdabar_e \approx 2^128$, the decomposition of 6 leads to a natural partition of the Universe in the Grandcosmos, and the following approximation for the celerity ratio $$ C/c\approx3^{128} \sqrt{ln2/2}$$ This confirms the role of quark up = 5 and \textit{quark d = 6 with a double structure}, in a sriking parallele between nuclear physics and cosmology.
