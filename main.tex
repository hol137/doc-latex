...
\caption{The Topological Axis.Double logarith (y = lnln(Y)) of main dimensionless physical quantities 
...
periodicity 8 [25] which at the origin of the name `topological axis`.
    ...
    the Kotov length, through a factor $2\pia$, with a = 137.036. For n = G, the Atiyah constant, it is the 
