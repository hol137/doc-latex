...
In the same manner, this article prefigures \textit{the fundamental theory,but revealing its arithmetical foundation: the Holic Principle}, recalled in section 6. There must exist multi-base algorithms able to explain the compatibiloity between thses two principles which seems at first sight contradictory. 
