...
magnitude, we infer rather precise relations. With the Hydrogen radius $r$, we infer $R/r \approx (4\pi \lambda_{CMB} /r_{H(0)} )^{4}$
precise to $0.6\%$. 
Considering the standard cosmological neutrino
background (CNB), whose wavelength is defined by $(\lambda_{CNB} / \lambda_{CMB})^{3} = 11/4$, we note that $$R/ \lambdabar_{e} \approx
