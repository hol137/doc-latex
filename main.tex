...
It appears also in the following holographic relation:
...
The central term $F^3/a$ shows another relation between $j$ and $\Gamma$, to 0.05 % and 0.2 \%:
\begin{equation}
...
$$R_{GC}/_lambdabar_e \approx 6^{128}/(1+1/\sqrt2)$$
leading to the approximation for the celerity ratio $ C/c \approx 3^{128} \sqrt{ln2/2}$. Moreover, one observes, to 2.6 %;
$(R_{GC}/_lambdabar_e)^3 \approx 150^137$, so the quark hypothesis u = 5, d = 6 is comforted by the Grandcosmos. This would imply that the quark d is composite.
