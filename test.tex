...
However, curiously, Eddington believed in the Openhagen statistical interpretation. Thus, he did not reached the above conclusions. Moreover, at his epoch the holography was not discovered: it is a strange fact of Science History that this essential property of wave was so lately discovered\cite{Gabor}. However, with his Large Number which fits so well the cosmic neutron population, Eddington anticipated the present fusion Physics-Arithmetic's and its touchstone, the Holic Principle. 
