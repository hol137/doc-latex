...
From the holographic two-step interaction \cite{Sanchez1}, it was deduced that the Kotov period is associated with the photon mass \cite{Marchal}. With the above value, it is $m_{ph} = \hbar/c^{2} t_{K} \approx 1.222 \times 10^{-55}$ kg, and the graviton mass is: 
