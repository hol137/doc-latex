...
$p \approx \Gamma (\pi e)^2$. There is a quasi-holographic relation connecting the constantes $e$, $\pi$ and $\gamma$ and the volume $v_2 = (4\pi/3) (ln2)^3$ (0 ppb and 0.046 \%):
\begin{equation}
e^{1/3} = (4\pi/3)\gamma^2 \approx v_2 
\end{equation}
$v_2$ is tied to $a$ through (354 ppb):
\begin{equation}
v_2^{16} \approx 3a^2/2\cdot 137 
\end{equation}
