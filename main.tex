...
mass ratio at an epoch during which its measurement was false to 3 $\sigma$. With the classical electron radius $r_e = \lambdabar_e/a$, this extends the Eq.(11) by a symmetric deviation, (-17 ppm and 16 ppm):
\begin{equation}
\lambdabar_M / r_{e} \approx (R_1l_K/R^{prime}r_e)^3 \approx(4\pi P/p_K)^4
\end{equation}

With the above $\mu$ value, it gives $\tau \approx 3477.441701$, which obeys, to 0.7 and -0.8 ppm: $e^{e^e}/a e^e \approx (F/137)^{3}/ (\mu\tau/j)^2 \approx  \sqrt{pH} (p/p_0)^2$, resulting from the elimination of $a_m = \sqrt{137a}$ in the following extension of the above relation defining $\mu$, giving a central role to the Tifft ratio $F/137$, and so defining the Higgs ratio $s$:
$$
\begin{array}{ll}
%
\displaystyle
