...
This is the extrapolation towards smaller numbers of the Double Larger Number correlation, using also the Carr\cite{Carr} and Davies\cite{Davies} relations. 
%The central dimension is d = 16, for a total of $2^7$ string dimensions in the Bott sequence. This suggests a liaison with the Eddigton's mtrix 16 $\times$ 16_cite{Eddington}. 
