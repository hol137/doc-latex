...
The present article shows that \textit{Physics is a unique part of Mathematics, which are presently incomplete}. We refute here the Multiverse Hypothesis by very precise fine-tuning (untill $10^{-9})$ between main physical and mathematical constants: $\pi$, $e$ and $\gamma$, the Euler-Mascheroni constant. Also, this study confirms the super-string theory, but with complete rehabilitation of the \textit{tachyonic} bosonic string theory.
