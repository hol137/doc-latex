...
%%\approx O_B^{1/12} $, see Eq.(), and $ D_{a} = 13^2 sqrt{5} + 70 \approx O_M^{3/61}$,
%%so connecting the two Monster's orders. Note that $61/2 \approx F\a^2$ to 0.04 \%. This introduces the next section.
