...
From $aF^2/W^2 \approx p$, this shows that the common origin of this Tau-Proton symmetry, completly ignored by the standard theory, is $tau \sim q \sim 2p$, with q = 2^{12}, the key number in section 9.2.   
