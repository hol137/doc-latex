...
=> $\Theta_{CMB} = 2.725820805 K$ which is the area of the 4-sphere of radius $\lambda_{CMB} / \lambdabar_{m}$, where $\lambdabar_{m} = (\lambdabar_{e} \lambdabar_{H} 2 )^{1/3} $, proving the relevance of
...
$$\sqrt{(R_{1} /a_{w} l_{K})} \approx frac{4\pi^{p}}{p_{0}} \rightarrow t_{K} \approx 9 600.591445 s$$ a relation independent from $G$. 
