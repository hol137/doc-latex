...
The ratios with $2\pi$ times the Nambu mass corresponds (respectively within 2.0 \% and 3.7\%)  to the \textit{canonical values} n = 24 and n = 26 (Fig.1). The following relation (0.1\%), will be very usefull in the section 5:
\begin{equation}
