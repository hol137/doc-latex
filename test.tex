...
\end{equation}
The deviation of the first relation is very close to that of Eq.11: $R_1^3\approxR_{GC}^3\lambdabar_M$. This induces, with precision 17 ppm, identified to 0.3 ppm with $np^2/H^2\sqrt{pH}, and 0.08 \%:
\begin{equation}
(R_{GC}l_P/Rr_e)^2\approx(R_1l_K/Rr_e)^3\approx 3^{1/3}\mu^{35}
\end{equation}
showing a quasi-holic form, which is completed by the study of the BH entropy of the Grandcosmos: (12 ppm, 100 ppm, 42 ppm):
\begin{equation}
