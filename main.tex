...
nuclear force. Looking for relations involving $a_{w}$ and the intermediate bosons ratios $W$ et $Z$, the computer indicates, with the neutron/electron mass ratio $n \approx 1838.68366089(17)$:
\begin{equation}
...
\end{equation}
This leads to Admitting the above relation, one defines 
\begin{equation} 
F = a_{w}^{1/2} = E_{F} /m_{e} c^{2} \approx 573007.3652
\end{equation}
textit{within its 0.25 ppm indetermination}.  
As ror the weak bosons, the values
\begin{equation}
...
\end{equation}
match the above relation, (Eq. 1) textit{in the ppb range}: 
\begin{equation}
