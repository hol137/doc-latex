...
\end{equation}
The existence of a Final Theory based on the Holic Principle (section 6) cannot be denied. The interpretation is clear: the 4D space-time in Grandcosmos is associated with a 9D space involving the Monster. \textit{This opens a path towards the Final Theory}. 
