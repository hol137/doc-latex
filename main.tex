...
with emphasis on the $10^{61}$ Trans-Plankian Quantized time, the Kotov's period, the Tifft's speed, the Koide-Sanchez constant, the Brannen matrix, the massive gluons and composite d quark. Cosmology must unblock by the oberving mature galaxies instead of that 'dark space' predicted by using the imperfect cosmological principle.  
