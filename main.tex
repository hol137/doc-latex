...
0.4 \%, 6 ppm, 0.4 ppm, 0.04 \%  
$$e^{e^e}\approx (lnp)^{lnp}          $$
$$e^{e^e} \approx 137 (e^{e})^3   $$
$$e^{e^e} \approx e^e a \sqrt{pH} (p/p_0)^2 $$
$$e^{e^e}\approx j^6/F $$
...
\begin{equation}
(1 + \mu + \tau)/2 = (1 + \sqrt\mu + \sqrt\tau)^2/3 = p_K \approx 4\pi\sqrt{apH}
\end{equation}
...
gives $\tau \approx 3477.441701$, which obeys, to 0.7 and -0.8 ppm: $e^{e^e}/a e^e \approx (F/137)^{3}/ (\mu\tau/j)^2 \approx  \sqrt{pH} (p/p_0)^2$, resulting from the elimination of $137a$ in the following extension of the above relation definig $\mu$, giving a central role to the Tifft ratio $F/137$, and so defining the Higgs ratio $s$:
\begin{equation}
F/137 = f \sqrt{s} =  \mu^2 \sqrt{pH}/137a \approx \sqrt{137a} (p/p_0) \tau /j
\end{equation}
(0.7 ppm). The above Koide constant $p_K \approx 1842.604994$ connects with the above Moonshine Monster dimension [23] $D = 196883$, to 48, 10, 13, 26 ppm:
...
\item 9/ The grandcosmos is huge but not infinte, in conformity with the Cosmological Computational Principle.
...
\bibitem{4} Bonvin V. Holicow, New cosmograil time delays of HE 0435-1223, arXiv: 1607.01790v2
(2016). % Here is referred book

\bibitem{5} Sanchez F.M., V. A. Kotov and C. Bizouard C. Towards a synthesis of two cosmologies: the
steady-state flickering Universe., \textit{Journal of Cosmology}, v.\, 17, 7225-7237 (2011). % Here is referred book

\bibitem{6} Bousso R., “The Holographic Principle”, \textit{Review of Modern Physics}, v.\, 74, p.834 (2002).

\bibitem{7} Duplantier B. Introduction à l'effet Casimir, Séminaire Poincar\'{e} 1 (2002), 41-54.. % Here is referred book

\bibitem{8} Damour T. The Entropy of Black Hole: a Primer. Séminaire Poincar\'{e} 2 (2003), 100 (89-115. % Here is referred book
