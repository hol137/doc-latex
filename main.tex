...
$$a/\pi\approx 496^2/137\Pi_0^{2/3} \approx p\beta^2/\Pi_+^{2/3}\approx (a/137)^{1/2} F^{10/3\sqrta}$$
...
\bibitem{31} Salingaros N. ``Some remarks on the algebra of Eddington's E
Numbers''. Foundations of Physics 15 (6), 683-691 (1985).

\bibitem{32} Weigel D., Veysseyre R. and Carel C. ``Sur les symboles du groupe
