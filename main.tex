...
\begin{equation}
2/\delta \approach (R/\jambdabar_e)^{1/210} \approach (1/2d_e) ln(pH)/lna \approach (1/d_e^2)ln\tau/ln\mu
R/\lambdabar_e \approx (2/\delta)^{210}
\end{equation}
where appear the masses of the heavy leptons (Section 4.6). This implies a dramatic geo-combinatorial relation between $a$ and $p$ : $p^(p²) ≈ (a^2)^(a^3)$ and confirms the central computational role of $\delta = R^{\prime}/R = pH/a^3$, which is to 1.6 ppm:
\begin{equation}
