...
It is now clear that present mathematics and Particle Physics are incomplete, and this Coherent Cosmology announces a reunification of \textit{Philosophy, Mathematics, Physics, Chemistry, Computational Science and Biology}. In particular, the pre-Socratic Parmenide philosophy of Permanence must be reconsidered favorably. Eddington's Fundamental Theory must be revisited, especially the genesis of his Large Number, so clearly tied to the $16 \times 16$ symmetric matrix.
...
\bibitem{Moulin} Moulin T. Symposium 4, 11eme congres International de Cybernetique. namur, Aout 1986: Utilisation e physique et biologie de referentiels spatio-structuro-temporels engendres par des Relateurs Arithmetiques. Moulin T. et Groupe Systema. Relateurs Arithmetiques (2 tomes): Ebauche du formalisme: avant la premiere jonction avec les structures de Lie. ENSTA.(1993). See also: Moulin T. Vallet C. Nature cognition and System 1. p294. Carvallo M. (Ed). Kluwer Acad. Publisher. (1988)
