...
\begin{equation}
(1 + \mu + \tau)/2 = (1 + \sqrt\mu + \sqrt\tau)^{2/3} = p_{K} \approx 4\pi (apH)^{1/4}
\end{equation}
...
gives $\tau \approx 3477.441701$, which obeys, to 0.7 and -0.8 ppm: $e^{e^e}/a e^e \approx (F/137)^{3}/ (\mu\tau/j)^2 \approx  \sqrt{pH} (p/p_0)^2$, resulting from the elimination of $a_{m} = \sqrt{137a}$ in the following extension of the above relation defining $\mu$, giving a central role to the Tifft ratio $F/137$, and so defining the Higgs ratio $s$:
\begin{equation}
F/137 = f \sqrt{s} = \mu^{2} \sqrt{pH}/a_{m}^{2} \approx \a_{m} (p/p_{0}) \tau /j \approx a^{1/6}p_{K} \approx jp/50
\end{equation}
(0.7 ppm, 0.3 \%, 0.1 \%). This shows that Cosmos uses the rationalisation 137/50 for $e$. The above Koide constant $p_K \approx 1842.604994$ connects with the above Moonshine Monster dimension [23] $D = 196883$, to 48, 10, 13, 26 ppm:
