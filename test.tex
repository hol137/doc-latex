...
%From Eqs. (48), (51) and (53), by taking the $137^{th}$ root, one obtains, to 0.03 \%: $496/j \approx %(ae^e/\Gamma)^{1/3}$, and more precisely (èè ppm) with the Higgs ratio defined in section 9.4:  $\rsqt{s}/j %\approx (ae^e/\Gamma)^{1/3}$.
...
\end{equation}
This has been found from the Muon ratio $mu \approx 3a/2 \approx e^{16/3}$, section 9.5.
