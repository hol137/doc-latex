...
periodicity 8 [25] which at the origin of the name 'topologic axis'.
    With unit the Electron Compton wavelength, in the macro-physics side, the Universe circumference is tied to the bosonic critical dimension 26, while reduction lead to n = 18 (thermal photon, tied to the Sternheimer scale 
