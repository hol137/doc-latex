...
\end{equation}
Equaling the tachonic celerities to $C_1$, and $m_{ph}$ with $\hbar/cl_K$ \cite{Marchal}, one gets a \textit{ppb correlation} with the above single electron radius $R_1$, taking account of the relation tying $R_1$ and $l_K$(section 4.2):
\begin{equation}
...
\end{equation}
showing a quasi-holic form. In accordance with the Hierarchy Principle, the holic form with dimension 210 is completed by the study of the BH entropy of the Grandcosmos: (12 ppm, 100 ppm, 42 ppm):
\begin{equation}
...
This Koide-Sanchez constant wil lbe precised to ppb precision in section 9.4.
...
\end{equation}
The small deviation is again attributed to a rationalisation of $\pi$ involving the heavy leaptons: 3,7,16,-(1+$\tau/\mu)^2$.
...
while, with $z = F/Z$ (3 ppm): $137/\Gamma \approx z^{\sqrt{f}/2}$, where $f$ is the Bizouard strong constant precising the inverse 8.44(5) of the standard 'strong coupling constant'\cite{Tanabashi}:
\begin{equation}
...
\bibitem{Sanchez5} Sanchez F.M. Electrical Moonshine. vixra:1801:0067 (2018). 
