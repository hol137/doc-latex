...
%\begin{equation}
 %i^{-lni}/\sqtr{d_e} \approx (\sqrt{a_e} + 1/\sqrt{a_e})^2    
%\end{equation}
...
\end{equation}
Since $wz\approx \sqre{a}$ \textit{this seems to be at the kernel of the Particle standard model}, calling for further study. 
