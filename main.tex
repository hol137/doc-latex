...
\end{equation}
but it took 9 years to nurture this publication [12], and it appeared later \cite{Sanchez1} that $m$ must be considered more precisely as the cubic root of the product 
$
...
\end{array}
$$
(0.7 ppm, 0.3 \%, 0.1 \%, 0.4  \% and 30 ppb). This shows that Cosmos uses the rationalisation 137/50 for $e$, and that the product $Pi_{par}$ of the 6 pariah group orders plays a role. The above Koide constant $p_K \approx 1842.604994$ connects with the above Moonshine Monster dimension [23] $D = 196883$, to 48, 10, 13, 26 ppm:
...
\bibitem{Bonvin} Bonvin V. ``Holicow, New cosmograil time delays of HE 0435-1223'',
