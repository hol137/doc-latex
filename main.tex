...
A $10^{61}$ Trans-Plankian Quantized time, the Kotov's period, the Tifft's speed, the Koide-Sanchez constant, massive gluons and composite d quark will unlock Particle Physics while the mature galaxies will be found in the far-field instead of a dark space, rejecting thus the evolutionary cosmology, ill-founded on the imperfect cosmological principle.
...
1. Principles of Hierarchy and Computation
...
~~     7.3. The Holic Principle in Cosmic Coherent Oscillation 
...
~~~    9.1. The Otimal Base $e$ is confirmed
   
~~~    9.2. The Lenz-Wyler's Formula
   
~~~    9.3. the Archimedes constant $\pi$ is a calculation base
...
\subsection{The Kotov cycle omnipresence in astrophysics}
...
\subsection{The Cosmic Oscillation and the Holic Principle}
...
\subsection {The Four Forces Unification ppb Fine-Tuning}
...
The standard model is unable to explain why there are three famillies of particles. Thus, the study of the muon and tau mass ratios is crucial. Now, the following Koide relation \cite{Koide}, which has a mathematical justification in term of circulating matrix, correctly predicted $\tau$ at an epoch (around 2000) during which its measurement was false to 3 $\sigma$. It can be wrote:
\begin{equation}
