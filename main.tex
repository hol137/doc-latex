...
\end{equation}
where the supplementary term $exp(e^2)$ is close to $a^{3/2}$. Note these properies of the 'economic number'
$$e^{e^e}\approx (lnp)^{lnp}  (0.04\%)$$
$$e^{e^e} \approx 137 \times exp(e^{e})^3  (6 ppm)$$
$$e^{e^e} \approx e^e p a^2/137   (46 ppm)$$
$$e^{e^e}\approx j^6/F  (0.004\%)$$
