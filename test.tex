...
\end{equation}  
This \textit{synthesis relation} confirms the coherence of the procedure. It will be of central importance in the following, (section 7.4) where the above lengths $l_P, $R$, $\lambdabar_M$,$ and $R_GC$ will be connected with $R^{\prime}$, the holographic reduction length of the Grandcosmos, and the following Kotov length. 
