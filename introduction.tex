...
main mathematical constants: π, e and γ . Also, these relations confirm the Super-string Theory and
...
1, and the Eddington's Large number N Ed = 136 × 2 256 are empathized. The second section will study
the role of intermediate mathematical constants such as the Eddington's constant 137. The third
Section involves mathematical constants, such as π and γ. By contrast, the optimal computation
