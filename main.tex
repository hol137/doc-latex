...
prime, by $T^{2} = L^{3} = n^{6}$ , meaning the classical 6D space of classical point mechanics. This particularizes
...
T^{2} = L^{3} = M^{5} = n^{30}
\end{equation}
where $M$ is a mass ratio. Recall that the lifetime of an unstable particle depends on the 5th power of its mass. This is called the Holic Principle, relates to the apparent world. The Complete Holic
Principle involves a term $F^{7}$, and so introduces the dimension $30 x 7 = 210$. It is confirmed by (to 0.03\%):
\begin{equation}
