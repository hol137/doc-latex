...
\end{equation}
The above term $R_1l_K/R^{\prime}r_e$ is close to $\sqrtO_M$ (1\%). The study of deviation, taking account of Eq.() shows the intermediate bosons ratios $W$ and $Z$, specified in section 9.4, leading to (-4 and 3.5 ppm):
\begin{equation}
...
\begin{equation}
137 p_0 W^2 Z^2/p a_w^2 \approx \sqrtO_M /(2a^2 P) \approx e^{-4a}
\end{equation}
