...
the Holic Principle, Eddington's, Wyler's, Atiyah's and Sternheimer's approaches  must unlock the Particle Physics, with emphasis on the $10^{61}$ Trans-Plankian Quantized time, the Kotov's period, the Tifft's speed, the Koide-Sanchez constant, the Brannen matrix, the massive gluons and composite d quark. Standard Cosmology, based on the imperfect cosmological principle will be refuted by the obervation of mature galaxies in the very far-field.  
