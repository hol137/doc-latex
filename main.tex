...
\end{equation}
meaning the ratio a/137 acts as a canonical ratio. Moreover, it is very close (3 ppb) to $3^{a/F}$, where the Tifft factor $F/a$ appears again, prving that the base 3, the optimal whole number basis is also used by the Cosmos.
