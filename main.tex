...
The present article shows that \textit{Physics is a part of Mathematics}, refuting the Multiverse Hypothesis by very precise fine-tuning ($10^{-9})$ between main physical and mathematical constants: $\pi$, $e$ and $\gamma$, the Euler-Mascheroni constant. Also, these relationships confirm the super-string theory but with complete rehabilitation of the tachyonic bosonic string theory.
