...
\begin{figure*}
\centering
\includegraphics[width=\textwidth*1.14,height=14cm]{./figures/figure}
...
The supplementary term $exp(e^2)$ being close to $a^{3/2}$. Note that the 'economic number' $E = exp(ee)\approx j^6/F$ (0.0\%), and that $e^2$ is the limit of the following musical series:
