...
The last equation means the implication of $B = exp(e^{\pi})$ in the ultimate theory. Indeed, it appears in the following relation, with the Fermi-Electron mass ratio $F$ value of Section III, to 0.3 ppm and 0.03 \% :

\begin{equation}
(\lambdabar_{CMB}/\lambdabar_e)^3 ≈ F^5/6 ≈ B^3/a
\end{equation}
 
It appears also in the following holographic relation, to 0.16 \% :

\begin{equation}
(4\pi/3) B^3 ≈ \pi(F^3/a)^2
\end{equation}
