...
\begin{table*}
 \caption{Topological Axis Data}
  \centering
  \begin{tabular}{llllll}
    \toprule
    \multicolumn{6}{c}{with \textit{invariant Hubble radius} $R  \approx$ 13.812 ~Gly (70.790 km/s$\cdot$Mpc), $\lambdabar_M = 2l_P^2/R \approx 3.9989\cdot10^{-96} m$, $T = \hbar^{4} /\rho_{c}^{3/2} G_{F}^{5/2} \approx 5.4829 \cdot 10^{57} s, ggggggggggggggggggggg$}                   \\
    \cmidrule(r){1-6}
