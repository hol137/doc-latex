...
$$\lambdabar_{e}/\lambdabar_{M} \sim (R/\lambdabar_{e})^{2} \sim (\lambdabar_{e}/ \lambdabar_{X})^{4} \sim (\lambda_{CMB}/ \lambdabar_{e})^{8} \\ \sim (\lambdabar_{e}/\lambdabar_{W})^{16} \sim (2r_{H} /\lambdabar_{e})^{32} \sim (\lambdabar_{e}/ l_{Gl} )^{64} \\ \sim (\lambdabar_{str} /\lambdabar_{e} )^{128} \sim 2^{256}$$
