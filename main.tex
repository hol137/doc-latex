...
\begin{equation}
\sqrt(\pi/3) r_e R_GC^2/R^3 \approx (l_K/r_e)^3 \approx (r_e/\lambdabar_M)(R^{\prime}/R_1)^3
\end{equation}
leading to the discovery that $r_e/\lambdabar_M$ is both a cube and a forth power (17 ppm, 1.8 ppm and 3\%):
\begin{equation}
r_e/\lambdabar_M \approx (R_1l_K/R^{\prime}r_e)^3 \approx (4\pi P/p_K)^4 \approx O_M^{3/2}
\end{equation}
