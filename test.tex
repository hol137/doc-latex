...
\end{array}
$$, and, to 8 ppm and 0.2 ppm:
\begin{equation}
e^{e^e}/(a-1)^2 \approx 4 ln P \approx a ln(9/2)
\end{equation}
showing the role of bases 2 and 3. Note that $e^2$ is the limit of the following musical series:
