...
taking account of the identity: $2l_P^2 = \lambdabar_M R = (R^{\prime}r_e)^2/(R_GC)l_P)^2, this leads to a number reduced in the ratio $\delta^3$ (17 ppm and 1.8 ppm) :
\begin{equation}
r_/\lambdabar_M \approx (R_1l_K/R^{\prime}r_e)^3 \approx (4\piP/p_K)^4
\end{equation}
where the forth root shows the Koide constant $p_K$, characteristic of the two Heavy Leoptons (see Eq.). The section 9 will show their holic liaison with the Monster group order.
