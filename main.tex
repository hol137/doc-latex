...
\item 6/ The so-called Dark energy proportion 0.7, is shown to be a false problem, since
3/10 is the trivial ratio between gravitational and critical energy. The Eddington's \textit{invariant} cosmological constant is rehabilitated, corresponding to a repulsive force proportional to distance, explaining \textit{exponential} recession.
