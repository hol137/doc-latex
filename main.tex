...
The last equation means the implication of $B = exp(e^{\pi})$ in the ultimate theory. Indeed, it appears in the following holographic relation, with the Fermi-Electron mass ratio $F$ value of Section III, to 0.3 ppm and 0.03 \% :

\begin{equation}
(ƛ_{CMB}/ƛ_e)^3 ≈ F^5/6 ≈ B^3/a
\end{equation}
