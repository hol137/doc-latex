...
Now, the Koide relation \cite{Atiyah1}, which has a mathematical justification in term of circulating matrix, correctly predicted $\tau$ at an epoch during which its measurement was false to 3 $\sigma$. : can be wrote:
\begin{equation}
