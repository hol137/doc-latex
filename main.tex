...
The mathematics-physics fusion is confirmed by $10^{-9}$ precise relations, implying the Eddington's constant 137 and the Atiyah's constant. Koide relation, massive gluons and composite d quark will deblock Particle Physics and mature galaxies will replace dark space, ruining thus the standard evolutionary cosmology, ill-founded on the imperfect cosmological principle.
...
6. The cosmoc Fine-Tuning and the Topological Axis

2. Arithmetical Logic: Holic Principle
...
8. Fine-Tuning with Intermediary Mathematical Constants
...
~~~    9.7. The central role of atiyah's constant
...
nuclear force. Looking for relations involving $a$, 137, $a_{w}$, the intermediate bosons $W$ et $Z$ and the mathematical constants, the computer indicates, with the neutron/electron mass ratio $n \approx 1838.68366089(17)$:
\begin{equation}
...
\end{equation}
Considering the above values, Eq (1) 
%%\begin{equation}
%%R/\sqrt(\lambdabar_{p} \lambdabar_{H} ) \approx (WZ)^{4}
%%\end{equation}
matches the above $G$ value in the ppb range. Moreover:
\begin{equation}
