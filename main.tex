...
mass ratio at an epoch during which its measurement was false to 3 $\sigma$. Now the Koide constant $p$_K verifies (0.5ppm, 40 ppb):
$$ p_K \approx 4\pi (apH)^{1/4} \approx (pH)^{1/2} (137a/136(a^{\prime}-1)^{1/4} d_e $$
