...
\end{equation}
meaning the ratio $a/137$ acts as a canonical ratio. Indeed, the Bizouard constant $f$, precizing [3] the inverse of the standard 'strong coupling constant' 0.1184(7), $$f = a_w/2\pi(pH)^{3/2} \approx 8.43450$$, appears as a computation basis, in, to 0.3, 0.2 and 0.7 \%:
$$(a/137)^F \approx 3^a \approx f^{f^2}/\pi \approx (O_B/f)^2 $$
proving that the base 3, \textit{the optimal whole number basis}, is also used by the Cosmos and that the cardinal order plays also a role (as confirmed below). 
Moreover, to 27 ppb:
$$ a/(a-1) \approx 3^{1/150}) $$
So, the basis 3 makes a liaison between $a/137$ and $a/(a-1)$, vert close (2 ppm) to the Bond factor [2] 137/136.
...
\item 7/ The very existence of dark matter is proven, from the number of neutrons in this fraction 3/10 of the visible Universe critical mass, which identifies with the very symmetric Eddington's number $136 \times 2^256$. The nature of dark matter is simply an anti-phase matter-antimatter oscillation [3].  
\item 8/ The introduction of the Topon
