...
The present article shows that \textit{Physics is a unique part of Mathematics}, refuting the Multiverse Hypothesis by very precise fine-tuning ($10^{-9})$ between main physical and mathematical constants: $\pi$, $e$ and $\gamma$, the Euler-Mascheroni constant. Also, these relationships confirm the super-string theory but with complete rehabilitation of the tachyonic bosonic string theory.
...
Since $R/\lambdabar_e \approx 2^128$, the decomposition 6 = 3 \times 2 leads to a natural partition of the Universe in the Grandcosmos, and the following approximation for the celerity ratio $$ C/c\approx3^{128} \sqrt{ln2/2}$$ This confirms the role of bases quark up = 5 and \textit{quark d = 6 with a double structure} in a sriking parallele between nuclear physics and cosmology. Elimination of $q$ leads to (2.6 \%):
