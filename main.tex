...
\end{equation} which traduces in function of $P = m_P/m_e$ by $ln^2(P^4/a^3) + 2 ln^2(P^2/pH) \approx 2 ln^2(2P^5/a^6)$. Moreover, to $10^{-7}$, corresponding to $7 \times 10^{-6}$ precision on the above G value:
...
\bibitem{3}  Sanchez F.M. \textit{Coherent Cosmology} Vixra.org,1601.0011. Sanchez F.M., Kotov V. and Bizouard C., textit{Towards Coherent Cosmolog}, Galilean Electrodynamics, special issue, winter 2013, pp 63-80.
Sanchez F.M. \textit{A Coherent Resonant  Ccosmology Approach and its Im^plications in Microphysics and Biology}, Progress in Theoretical Chemistry and Physics 30, pp. 375-407.Springer (2017) DOI 10.1007/978-3-319-50255-7-2. % Here is referred book
