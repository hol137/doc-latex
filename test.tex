...
\textit{In the macro-physics side, with length unit the Electron Compton wavelength} the Universe circumference 
   ...
   \textit{In the micro-physics side, with the same length unit, the Electron Compton wavelength}, the Space-Time-Matter
