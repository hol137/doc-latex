...
$$e_{GC} = (3 × 16 × 787)/(13 × 1069) \approx (a\mu/3\tau) (e/2)^{1/420}$$
...
\begin{equation}
2/\delta = 2a^3/pH \approx ln(pH)/2d_e lna \approx (ln\tau/ln\mu)/d_e^² \approx d_e^² ln s/lnt
\end{equation}

where $s ≈ (F/af)^2 $ is compatible with the mass ratio Higgs-Boson/Electron, corresponding to 125.6 GeV.
