...
The holic resolving term is the Lenz-Wyler form $p_{00} = 6\pi_0^5$, where $\pi_0$ has the fractional development: 3;7;16;($sqrt{s}+1$).
 With the Atiyah constant $\Gamma = \gamma a/\pi$ is (section 8.2), inside the 250 ppb indetermination:  
...
\begin{equation}
Q \approx P^e \approx X^{\sqrt a} \approx 48 \sqrt{5/w} O_M Z
\end{equation}
...
\end{equation}
This enligths a liaison between the monster and the $J_3$ orderss, while these two groups have no known relations (0.2 ppm):
\begin{equation}
