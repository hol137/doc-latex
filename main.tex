...
\end{equation}
confirming the central role of 496. Note also that $O_MO_B \approx  n_{ph}/\delta^{1/2}$, where $$n_{ph}\approx (3/\pi) exp(e^6/2)$$ (to 0.2 \%) is the photon number in the visible universe. Therefore 496, $p$ and $g_0$ are also privileged computations bases. 

From the Eqs (37), (41) and (44), by taking the $137^{th}$ root, one obtains, to 0.03 \%: $$496/j \approx (ae^e/\Gamma)^{1/3}$$
