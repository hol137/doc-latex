...
From three of the above equations, by taking the $137^{th}$ root, one obtains, to 0.03 \%: $496/j \approx (ae^e/\Gamma)^{1/3}$
...
\end{equation}
This value is confirmed by the tachyonic ratio $Q$ and the Planck Wien term $5/w$ (section 7.1) (3\%, 1\%, 60 ppb) 
\begin{equation}
Q = R_GC/R \approx P^e \approx W^{\sqrt a} \approx 48 \sqrt{5/w}~ O_M Z
\end{equation}
